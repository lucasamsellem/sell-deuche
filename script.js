...
// Fonction pour afficher les selleries dans les conteneurs
...
// Boucle pour rendre les selleries dans chaque conteneur
selleriesListContainers.forEach((list, i) => renderSelleries(selleriesData[i], list))
