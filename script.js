const selleriesListRowOne = document.querySelector('.row-one')
const selleriesListRowTwo = document.querySelector('.row-two')
const availableSelleriesList = document.querySelector('.available-selleries-list')

// Capitalize the first letter of a string
const formatFirstLetter = str => str.charAt(0).toUpperCase() + str.slice(1)

const selleriesRowOne = [
  {
      ...
      ({ img, alt, material, model, year, details }) => `
        <li class="sellerie-item">
          ...
          <ul class="specs">
            ...
            <li class='sellerie-details'>${details ? formatFirstLetter(details) : ''}</li>
          </ul>
        </li>
      `
    )
...
renderSelleries(selleriesRowOne, selleriesListRowOne)
renderSelleries(selleriesRowTwo, selleriesListRowTwo)
renderSelleries(availableSelleries, availableSelleriesList)
